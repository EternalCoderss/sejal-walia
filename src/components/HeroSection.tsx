      ...
      <div className="container relative z-10 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.h1
            ...
            className="text-5xl md:text-7xl lg:text-8xl font-bold font-space leading-tight mb-6"
          >
            Hi, I'm{' '}
          ...
          >
            {[
              ...
              <motion.div
                ...
                className="glass glass-hover rounded-xl p-4 md:p-6"
              >
                <div className="text-2xl md:text-3xl font-bold text-gradient font-space">
                  {stat.value}
                </div>
